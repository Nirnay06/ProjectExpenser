  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <Button color="primary" startDecorator={<AddCircleOutline />} size="sm" onClick={() => setOpenAddModal(true)}>
          Add Category
        </Button>
      </Box>
      ...
      <React.Fragment>
        <Modal open={openAddModal} onClose={() => setOpenAddModal(false)}>
          <ModalDialog aria-labelledby="add-category-modal" size="sm">
            <ModalClose />
            <Typography id="add-category-modal" level="h2">
              Add Category
            </Typography>
            <Divider sx={{ my: 2 }} />
            <form
            ...
            >
              <Stack spacing={2}>
                ...
                <Box sx={{ display: "flex", gap: 1, justifyContent: "flex-end" }}>
                  <Button type="button" variant="soft" color="neutral" onClick={() => setOpenAddModal(false)}>
                    Cancel
                  </Button>
