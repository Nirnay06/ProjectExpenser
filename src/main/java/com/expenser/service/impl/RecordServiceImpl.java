...
import com.expenser.service.RecordLabelService;
...
public class RecordServiceImpl implements RecordService{
	...
	private UserRecord updateRecordFromDTO(RecordDTO recordDTO, UserRecord record) {
		...
		if(recordDTO !=null) {
			...
			if(recordDTO.getCurrencyIdentifier()!=null) {
				UserCurrency currency = userCurrencyRepository.findByIdentifier(recordDTO.getCurrencyIdentifier());
	...
	public List<RecordDTO> getAllRecordsByCurrencyandClient(String currencyIdentifier, String clientIdentifier) {
		List<UserRecord> userRecords = recordRepository.findByUserCurrencyAndClient(currencyIdentifier, clientIdentifier);
		return getDTOsFromEntityList(userRecords);
	}
}
