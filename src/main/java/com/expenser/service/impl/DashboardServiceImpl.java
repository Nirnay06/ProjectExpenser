			...
			if(!CollectionUtils.isEmpty(resultList)) {
				...
				for(CurrencyDTO currency :currencyList.values()) {
					if (amountByCurrency.containsKey(currency.getIdentifier())) {
						...
						details.put("CURRENCY_ICON", currency.getCurrencyIcon());
						details.put("CURRENCY_TITLE", currency.getCurrencyTitle());
						details.put("CURRENCY_ABBR", currency.getCurrencyAbbreviation());
