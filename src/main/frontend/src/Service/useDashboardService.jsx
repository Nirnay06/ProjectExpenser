...
const useDashboardService = () => {
  ...
  const getStatsForLastRecordCard = (accountIdentifier, startDate, endDate, setData) => {
    sendRequest(
      { url: `/api/dashboard/statsForLastRecordCard/${accountIdentifier}/${startDate}/${endDate}` },
      (data) => {
        setData(data);
      },
      () => {},
  ...
  const getStatsForCashFlowCard = (accountIdentifier, startDate, endDate, setData) => {
    sendRequest(
      { url: `/api/dashboard/statsForCashFlowCard/${accountIdentifier}/${startDate}/${endDate}` },
      (data) => {
        setData(data);
      },
      () => {},
  ...
  const getStatsForCurrencyBalanceCard = (accountIdentifier, startDate, endDate, setData) => {
    sendRequest(
      { url: `/api/dashboard/statsForCurrencyBalanceCard/${accountIdentifier}/${startDate}/${endDate}` },
      (data) => {
        setData(data);
      },
      () => {},
  ...
  const getStatsForDashboardGauge = (accountIdentifier, startDate, endDate, setData) => {
    sendRequest(
      { url: `/api/dashboard/statsForDashboardGauge/${accountIdentifier}/${startDate}/${endDate}` },
      (data) => {
        setData(data);
      },
      () => {},
  ...
  const getStatsForExpenseStructure = (accountIdentifier, startDate, endDate, setData) => {
    sendRequest(
      { url: `/api/dashboard/statsForExpenseStructureCard/${accountIdentifier}/${startDate}/${endDate}` },
      (data) => {
        setData(data);
      },
      () => {},
